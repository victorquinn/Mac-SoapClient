...
//}
//
//- (float)splitView:(NSSplitView *)sender constrainSplitPosition:(float)proposedMin ofSubviewAt:(int)offset;
//{
//    NSLog(@"Providing minimum!");
//    return 50.00;
//}

//- (float)splitView:(NSSplitView *)sender constrainMinCoordinate:(float)proposedMin ofSubviewAt:(int)offset;
//{
//    NSLog(@"Proposed Min: %f", proposedMin);
//	/*if (offset == 0) {
//		return 80;
//	}
//	return proposedMin;*/
